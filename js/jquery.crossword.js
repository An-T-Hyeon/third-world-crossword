...
(function($){
	$.fn.crossword = function(entryData) {
			...
			*/
			...
			this.after('<div id="puzzle-clues"><h2>가로</h2><ol id="across"></ol><h2>세로</h2><ol id="down"></ol></div>');
					...
					puzzEl.delegate('input', 'keyup', function(e){
						...
						if ( e.keyCode === 9) {
							...
							if (e.keyCode === 8 || e.keyCode === 46) {
                                if ($(this).val().replace(/[\0-\x7f]|([0-\u07ff]|(.))/g,"$&$1$2").length==0) currOri === 'across' ? nav.nextPrevNav(e, 37) : nav.nextPrevNav(e, 38);
							} else {
								nav.nextPrevNav(e);
							}
